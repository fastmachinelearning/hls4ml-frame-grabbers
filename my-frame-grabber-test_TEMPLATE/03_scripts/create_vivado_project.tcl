...
proc customlogicCreateProject {} {
	...
	set files [list \
		...
		"[file normalize "$customlogic_dir/04_ref_design/pix_threshold_proc.vhd"]"\
		"[file normalize "$customlogic_dir/04_ref_design/pix_threshold.vhd"]"\
		"[file normalize "$customlogic_dir/04_ref_design/pix_threshold_wrp.vhd"]"\
    ...
    "[file normalize "$customlogic_dir/04_ref_design/CustomLogic.vhd"]"\
		"[file normalize "$customlogic_dir/04_ref_design/result_writeout.v"]"\
