...
################################################################################
# (Coaxlink Quad CXP-12) CustomLogic design common location constraints
################################################################################

# Oscillator
set_property PACKAGE_PIN AD11 [get_ports osc_125M_p]
set_property IOSTANDARD BLVDS_25 [get_ports osc_125M_p]

# CoaXPress over Fiber
set_property PACKAGE_PIN M6 [get_ports qsfp_gth_clk_p]
set_property PACKAGE_PIN M2 [get_ports {qsfp_rx_p[0]}]
set_property PACKAGE_PIN K2 [get_ports {qsfp_rx_p[1]}]
set_property PACKAGE_PIN H2 [get_ports {qsfp_rx_p[2]}]
set_property PACKAGE_PIN F2 [get_ports {qsfp_rx_p[3]}]
set_property PACKAGE_PIN N4 [get_ports {qsfp_tx_p[0]}]
set_property PACKAGE_PIN L4 [get_ports {qsfp_tx_p[1]}]
set_property PACKAGE_PIN J4 [get_ports {qsfp_tx_p[2]}]
set_property PACKAGE_PIN G4 [get_ports {qsfp_tx_p[3]}]
# QSFP+
set_property PACKAGE_PIN AF12 [get_ports {qsfp_i2c_sda}]
set_property PACKAGE_PIN AD15 [get_ports {qsfp_nmodsel}]
set_property PACKAGE_PIN AE15 [get_ports {qsfp_nreset}]
set_property PACKAGE_PIN AF14 [get_ports {qsfp_nmodprs}]
set_property PACKAGE_PIN AF13 [get_ports {qsfp_i2c_scl}]
set_property PACKAGE_PIN AE16 [get_ports {qsfp_lpmodetxdis}]
set_property PACKAGE_PIN AF15 [get_ports {qsfp_nintrxlos}]
set_property IOSTANDARD LVCMOS33 [get_ports {qsfp_i2c_sda}]
set_property IOSTANDARD LVCMOS33 [get_ports {qsfp_nmodsel}]
set_property IOSTANDARD LVCMOS33 [get_ports {qsfp_nreset}]
set_property IOSTANDARD LVCMOS33 [get_ports {qsfp_nmodprs}]
set_property IOSTANDARD LVCMOS33 [get_ports {qsfp_i2c_scl}]
set_property IOSTANDARD LVCMOS33 [get_ports {qsfp_lpmodetxdis}]
set_property IOSTANDARD LVCMOS33 [get_ports {qsfp_nintrxlos}]

# Fan
set_property PACKAGE_PIN J11 [get_ports fanspeed]
set_property PACKAGE_PIN V12 [get_ports fanpwm]
set_property IOSTANDARD LVCMOS18 [get_ports fanspeed]
set_property IOSTANDARD LVCMOS33 [get_ports fanpwm]

# I/Os
set_property PACKAGE_PIN D9 [get_ports {csync[1]}]
set_property PACKAGE_PIN D10 [get_ports {csync[2]}]
set_property PACKAGE_PIN D11 [get_ports {csync[3]}]
set_property IOSTANDARD LVCMOS18 [get_ports {csync[*]}]
set_property DRIVE 8 [get_ports {csync[*]}]
# I/O Set 1
set_property PACKAGE_PIN Y12 [get_ports {ttlio1_data[1]}]
set_property PACKAGE_PIN W8 [get_ports {ttlio1_data[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ttlio1_data[*]}]
set_property DRIVE 4 [get_ports {ttlio1_data[*]}]
set_property PACKAGE_PIN W9 [get_ports {ttlio1_dir[1]}]
set_property PACKAGE_PIN AA13 [get_ports {ttlio1_dir[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ttlio1_dir[*]}]
set_property DRIVE 4 [get_ports {ttlio1_dir[*]}]
set_property PACKAGE_PIN AE10 [get_ports {iout1[1]}]
set_property PACKAGE_PIN AF10 [get_ports {iout1[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {iout1[*]}]
set_property PACKAGE_PIN AB10 [get_ports {iin1[1]}]
set_property PACKAGE_PIN AB9 [get_ports {iin1[2]}]
set_property PACKAGE_PIN AC8 [get_ports {iin1[3]}]
set_property PACKAGE_PIN AD8 [get_ports {iin1[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {iin1[*]}]
set_property PACKAGE_PIN AA10 [get_ports {din1[1]}]
set_property PACKAGE_PIN AA9 [get_ports {din1[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {din1[*]}]
# I/O Set 2
set_property PACKAGE_PIN AA14 [get_ports {ttlio2_data[1]}]
set_property PACKAGE_PIN W14 [get_ports {ttlio2_data[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ttlio2_data[*]}]
set_property DRIVE 4 [get_ports {ttlio2_data[*]}]
set_property PACKAGE_PIN Y13 [get_ports {ttlio2_dir[1]}]
set_property PACKAGE_PIN W13 [get_ports {ttlio2_dir[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {ttlio2_dir[*]}]
set_property DRIVE 4 [get_ports {ttlio2_dir[*]}]
set_property PACKAGE_PIN W15 [get_ports {iout2[1]}]
set_property PACKAGE_PIN Y15 [get_ports {iout2[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {iout2[*]}]
set_property PACKAGE_PIN AB14 [get_ports {iin2[1]}]
set_property PACKAGE_PIN AC14 [get_ports {iin2[2]}]
set_property PACKAGE_PIN AA15 [get_ports {iin2[3]}]
set_property PACKAGE_PIN AB15 [get_ports {iin2[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {iin2[*]}]
set_property PACKAGE_PIN AA12 [get_ports {din2[1]}]
set_property PACKAGE_PIN AC13 [get_ports {din2[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {din2[*]}]
# I/O Extension
set_property PACKAGE_PIN AD14 [get_ports io_ext1_1wire]
set_property IOSTANDARD LVCMOS33 [get_ports io_ext1_1wire]
set_property PACKAGE_PIN AE13 [get_ports {io_ext1[1]}]
set_property PACKAGE_PIN AE12 [get_ports {io_ext1[2]}]
set_property PACKAGE_PIN AC12 [get_ports {io_ext1[3]}]
set_property PACKAGE_PIN AD10 [get_ports {io_ext1[4]}]
set_property PACKAGE_PIN AD9 [get_ports {io_ext1[5]}]
set_property PACKAGE_PIN AC11 [get_ports {io_ext1[6]}]
set_property PACKAGE_PIN AB11 [get_ports {io_ext1[7]}]
set_property PACKAGE_PIN AB12 [get_ports {io_ext1[8]}]
set_property PACKAGE_PIN AA8 [get_ports {io_ext1[9]}]
set_property PACKAGE_PIN Y8 [get_ports {io_ext1[10]}]
set_property PACKAGE_PIN Y10 [get_ports {io_ext1[11]}]
set_property PACKAGE_PIN Y11 [get_ports {io_ext1[12]}]
set_property IOSTANDARD LVCMOS33 [get_ports {io_ext1[*]}]
# I/O Expander
set_property PACKAGE_PIN W11 [get_ports led_scl]
set_property PACKAGE_PIN W10 [get_ports led_sda]
set_property IOSTANDARD LVCMOS33 [get_ports led_scl]
set_property IOSTANDARD LVCMOS33 [get_ports led_sda]
set_property DRIVE 4 [get_ports led_scl]
set_property DRIVE 4 [get_ports led_sda]

# PEG Status
set_property PACKAGE_PIN A13 [get_ports peg_prst_12v]
set_property IOSTANDARD LVCMOS18 [get_ports peg_prst_12v]
set_property PACKAGE_PIN A12 [get_ports npeg_prst]
set_property IOSTANDARD LVCMOS18 [get_ports npeg_prst]

# Configuration
set_property PACKAGE_PIN AC16 [get_ports cfg_sda]
set_property PACKAGE_PIN AD16 [get_ports cfg_scl]
set_property PACKAGE_PIN AD19 [get_ports cfg_wp_n]
...
# Feature Bits
set_property PACKAGE_PIN F13 [get_ports {featbit[0]}]
set_property PACKAGE_PIN E13 [get_ports {featbit[1]}]
set_property PACKAGE_PIN E12 [get_ports {featbit[2]}]
set_property PACKAGE_PIN F12 [get_ports {featbit[3]}]
set_property PACKAGE_PIN G12 [get_ports {featbit[4]}]
set_property IOSTANDARD LVCMOS18 [get_ports {featbit[*]}]


################################################################################
# (Coaxlink QSFP+) DDR4 IO Constraints
################################################################################
...
################################################################################
# (Coaxlink QSFP+) PCIe IO Constraints
################################################################################
# Reset/Wake/Clock
