...
proc customlogicCreateProject {} {
	...
	set files [list \
		"[file normalize "$customlogic_dir/04_ref_design/CustomLogicPkg.vhd"]"\
		...
		"[file normalize "$customlogic_dir/02_coaxlink/ips/clk_wiz_xgmii_x2.xcix"]"\
		...
		"[file normalize "$customlogic_dir/02_coaxlink/ips/fifo_async_72bx512.xcix"]"\
		...
		"[file normalize "$customlogic_dir/02_coaxlink/ips/phy_10g_ethernet.xcix"]"\
  ...
  add_files -norecurse [glob 05_model_design_hls/myproject_axi/KCU035/syn/vhdl/*.vhd] -fileset sources_1
	...
	set files [list \
		"[file normalize "$customlogic_dir/02_coaxlink/constr/CxlQsfp_loc_common.xdc"]"\
		"[file normalize "$customlogic_dir/02_coaxlink/constr/CxlQsfp_timing_common.xdc"]"\
