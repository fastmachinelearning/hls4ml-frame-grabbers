...
set_false_path -from [get_pins */iCxphTportDl*/dl_rate_ch_t_reg/C] -to [get_pins {*/iCxphTportDl*/dl_rate_ch_t_s_reg[2]/D}]
set_false_path -from [get_pins */iCxphTportDl*/dl_relock_req_t_reg/C] -to [get_pins {*/iCxphTportDl*/dl_relock_req_t_s_reg[2]/D}]
set_false_path -from [get_pins {*/iCxphGth/iGthCxpLow/inst/gen_gtwizard_gthe3_top.gth_cxp_low_cxp12_gtwizard_gthe3_inst/gen_gtwizard_gthe3.gen_channel_container[2].gen_enabled_channel.gthe3_channel_wrapper_inst/channel_inst/gthe3_channel_gen.gen_gthe3_channel_inst[*].GTHE3_CHANNEL_PRIM_INST/RXUSRCLK2}] -to [get_pins {*/iCxphTportDl*/gtx_resetdone_s_reg[2]/D}]
...
set_max_delay -datapath_only -from [get_pins {*/*/*/HEARTBEAT_REC_INST/hbt_timestamp_reg_reg[*]/C}] -to [get_pins {*/iHbtFifo/write_reg_reg[*]/D}] 8.0
set_max_delay -datapath_only -from [get_pins {*/*/*/HEARTBEAT_REC_INST/hbt_host_id_reg_reg[*]/C}] -to [get_pins {*/iHbtFifo/hbt_metadata_reg_reg[*]/D}] 8.0
set_max_delay -datapath_only -from [get_pins {*/*/*/STM_READER_INST/stat_err_sts_tag_reg[*]/C}] -to [get_pins {*/gMementoChannel[*].stat_war_sts_tag_l_reg[*][*]/D}] 8.0

# -- CXP LINK ERROR COUNTER constraints -----------------------------
set_false_path -from [get_pins {*/gCDC_LINK[*].iCDC_dl_lock/iPassSteady_xpm/iXpmCdcSingle/syncstages_ff_reg[*]/C}] -to [get_pins {*/*/*/MULTILINK_GEN[*].LINK_ERR_CNT_INST/EncLock_s_reg[*]/D}]
...
set_max_delay -datapath_only -from [get_pins {*/evt_tag_ack_l0_reg[*][*]/C}] -to [get_pins {*/evt_tag_ack_l1_reg[*][*]/D}] 8.0
set_max_delay -datapath_only -from [get_pins {*/evt_ack_tog_reg[*]/C}] -to [get_pins {*/evt_ack_sr_333MHz_reg[*][*]/D}] 8.0
...
set_max_delay -datapath_only -from [get_pins {*/iFanSpeedCtrl/FanPulseCounter_l_reg[*]/C}] -to [get_pins {*/iFanSpeedCtrl/FanSpeedMeasured_i_reg[*]/D}] 8.000
